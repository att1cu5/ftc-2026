...
public class W_nonortho extends LinearOpMode {
  double objectA=0;
  IMU imu;
  public double anglestartA=35.88648577;//degrees change angle if neccesary
  public double anglestartB=34.21570213;//degrees change angle if neccesary
 ...
 public class PIDCONTOLLERBL{
  ...
  public void runOpMode() throws InterruptedException{
    ...
    while (opModeIsActive()) {
      ...
      double powerBL=BLA(currentpositionBL,8);
      double powerFL=FLA(currentpositionFL,8);
      double powerFR=FRA(currentpositionFR,8);
      double powerBR=BRA(currentpositionBR,8);
